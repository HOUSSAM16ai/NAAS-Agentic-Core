...
| `decisions.md` | سجلّ القرارات المعمارية **D-001 → D-285** — كل قرار بسرده وجذره ودليله الحيّ. أحدثها: **D-285** (أوّل قياسٍ على نظامٍ لم نكتبه) · **D-284** («خفيف» يصير رقماً) · **D-283** (الدَّين غير المُصنَّف يتقلّص ولا ينمو) · **D-282** (قناة التمويل ليست خطّ إيراد). | سجلّ ملزِم |
