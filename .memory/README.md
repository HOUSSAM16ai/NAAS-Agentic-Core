...
| `decisions.md` | سجلّ القرارات المعمارية **D-001 → D-280** — كل قرار بسرده وجذره ودليله الحيّ. أحدثها: **D-280** (أرشيف الحوادث أصلٌ قابل للبيع: ذخيرةٌ مُشتَقّة · قياسٌ حتمي · والبوّابة لا تعتمد نفسها) و**D-279** (نظام المسارين: هندسة المنتج وإنتاج القيمة/العملة الصعبة ببوابة التقاء إلزامية). | سجلّ ملزِم |
