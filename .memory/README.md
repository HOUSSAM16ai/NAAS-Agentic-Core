...
| `decisions.md` | سجلّ القرارات المعمارية D-001→**D-190** (ADR log) | سجلّ ملزِم |
| `issues.md` | سجلّ الكوارث المُشخَّصة والمُصلَحة ISS-001→**ISS-141** (منها ISS-137 · ISS-140-ج/د · **ISS-141 (تدوير مفاتيح)** مفتوحة) | سجلّ ملزِم |
