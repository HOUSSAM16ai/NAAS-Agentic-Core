...
| `decisions.md` | سجلّ القرارات المعمارية **D-001 → D-286** — كل قرار بسرده وجذره ودليله الحيّ. أحدثها: **D-286** (الدفعة الآلية تُقاس مجموعةً، والمُحلِّل لا يكفي) · **D-285** (أوّل قياسٍ على نظامٍ لم نكتبه) · **D-284** («خفيف» يصير رقماً) · **D-283** (الدَّين غير المُصنَّف يتقلّص ولا ينمو). | سجلّ ملزِم |
