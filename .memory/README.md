...
| `decisions.md` | سجلّ القرارات المعمارية **D-001 → D-284** — كل قرار بسرده وجذره ودليله الحيّ. أحدثها: **D-284** («خفيف» يصير رقماً: كلفة كل دستورٍ مقابل جرّه) و**D-283** (المرجع بلا سلطةٍ ليس مرجعاً: الدَّين غير المُصنَّف يتقلّص ولا ينمو) و**D-282** (قناة التمويل ليست خطّ إيراد: التصنيف قرارٌ مكتوب، والرقم يحمل وسم ثقته) و**D-281** (البيئة تُغلِّف المُتحقِّق: المكافأة تقرأ المسار لا المخرَج). | سجلّ ملزِم |
| `issues.md` | سجلّ الكوارث المُشخَّصة والمُصلَحة **ISS-001 → ISS-196** — كلٌّ بجذرها ودليلها الحيّ وشرط إغلاقها. أحدثها: **ISS-196** (بابٌ مُعلَنٌ في العقد ومُقفَلٌ في الفارض · وفارضٌ يُقال إنه مسلوك وهو ميت) و**ISS-195** (قائمةٌ خارجية تُقرأ إعجاباً لا عقداً). | سجلّ ملزِم |
