...
| `decisions.md` | سجلّ القرارات المعمارية **D-001 → D-281** — كل قرار بسرده وجذره ودليله الحيّ. أحدثها: **D-281** (البيئة تُغلِّف المُتحقِّق: المكافأة تقرأ المسار لا المخرَج، والمكتبة تُرجِع بياناتٍ ولا تطبع) و**D-280** (أرشيف الحوادث أصلٌ قابل للبيع: ذخيرةٌ مُشتَقّة · قياسٌ حتمي · والبوّابة لا تعتمد نفسها). | سجلّ ملزِم |
