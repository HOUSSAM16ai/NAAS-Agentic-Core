...
| `issues.md` | سجلّ الكوارث المُشخَّصة والمُصلَحة **ISS-001 → ISS-199** — كلٌّ بجذرها ودليلها الحيّ وشرط إغلاقها. أحدثها: **ISS-199** (بوّابةٌ حاجبة على عطبٍ مؤجَّلٍ عمداً، ورأسٌ يصف نقيض تنفيذه — ✅ مُغلقة) · **ISS-198** (المزامنة تَعِد بالتطابق الكامل وتُنفّذ فرعاً واحداً — ✅ مُغلقة) · **ISS-197** (المرآة متوقّفة سبعة أيام، والفشل يُعاد بدل أن يُقرأ — ✅ مُغلقة). | سجلّ ملزِم |
