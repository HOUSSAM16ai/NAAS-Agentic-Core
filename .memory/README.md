...
| `decisions.md` | سجلّ القرارات المعمارية D-001→**D-188** (ADR log) | سجلّ ملزِم |
| `issues.md` | سجلّ الكوارث المُشخَّصة والمُصلَحة ISS-001→**ISS-139** (منها ISS-137 **مفتوح**) | سجلّ ملزِم |
