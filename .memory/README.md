...
| `decisions.md` | سجلّ القرارات المعمارية **D-001 → D-287** — كل قرار بسرده وجذره ودليله الحيّ. أحدثها: **D-287** (الدفعة الآلية تسقط في بوّابةٍ لا تجتازها، والأرضية تُرفَع مع الشجرة) · **D-286** (الدفعة الآلية تُقاس مجموعةً، والمُحلِّل لا يكفي) · **D-285** (أوّل قياسٍ على نظامٍ لم نكتبه) · **D-284** («خفيف» يصير رقماً). | سجلّ ملزِم |
| `issues.md` | سجلّ الكوارث المُشخَّصة والمُصلَحة **ISS-001 → ISS-197** — كلٌّ بجذرها ودليلها الحيّ وشرط إغلاقها. أحدثها: **ISS-197** (المرآة متوقّفة منذ سبعة أيام، والفشل يُعاد بدل أن يُقرأ — ✅ مُغلقة بتطابق الـSHA) · **ISS-196** (بابٌ مُعلَنٌ في العقد ومُقفَلٌ في الفارض · وفارضٌ يُقال إنه مسلوك وهو ميت) · **ISS-195** (قائمةٌ خارجية تُقرأ إعجاباً لا عقداً). | سجلّ ملزِم |
