...
| `decisions.md` | سجلّ القرارات المعمارية **D-001 → D-282** — كل قرار بسرده وجذره ودليله الحيّ. أحدثها: **D-282** (قناة التمويل ليست خطّ إيراد: التصنيف قرارٌ مكتوب، والرقم يحمل وسم ثقته) و**D-281** (البيئة تُغلِّف المُتحقِّق: المكافأة تقرأ المسار لا المخرَج). | سجلّ ملزِم |
