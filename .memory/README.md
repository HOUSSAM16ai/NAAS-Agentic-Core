...
| `issues.md` | سجلّ الكوارث المُشخَّصة والمُصلَحة **ISS-001 → ISS-198** — كلٌّ بجذرها ودليلها الحيّ وشرط إغلاقها. أحدثها: **ISS-198** (المزامنة تَعِد بالتطابق الكامل وتُنفّذ فرعاً واحداً — ✅ مُغلقة) · **ISS-197** (المرآة متوقّفة سبعة أيام، والفشل يُعاد بدل أن يُقرأ — ✅ مُغلقة بتطابق الـSHA) · **ISS-196** (بابٌ مُعلَنٌ في العقد ومُقفَلٌ في الفارض). | سجلّ ملزِم |
