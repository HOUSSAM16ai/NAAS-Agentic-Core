...
| `decisions.md` | سجلّ القرارات المعمارية D-001→**D-208** (ADR log) | سجلّ ملزِم |
| `issues.md` | سجلّ الكوارث المُشخَّصة والمُصلَحة ISS-001→**ISS-149** (ISS-149 أُغلق في D-208؛ ISS-148 في D-207؛ ISS-144 في D-206؛ يبقى ISS-137 · **ISS-141 (تدوير مفاتيح — إجراء المالك)** · ISS-142 · **ISS-145 (212 صفّاً فارغاً)** · **ISS-146 (توجيه تربوي بدور user)** · **ISS-147 (تذبذب 401)** مفتوحة) | سجلّ ملزِم |
