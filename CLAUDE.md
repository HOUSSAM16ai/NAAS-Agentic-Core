...
- **العزل والبرهان الثلاثي على الطرف الثالث** (L4/L5 · D-074 · D-245): كلّ نداءٍ معزولٌ بمهلةٍ صريحة وفشلُه يُبتلَع — ⛔ لا يكسر دور طالبٍ أبداً. ومفتاحٌ في البيئة **ليس قدرة**: المسبار الحيّ هو الساق الثالثة، يظهر في `/health` ويُشغَّل في `live-e2e`.
