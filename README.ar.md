...
└── CLAUDE.md               الدستور التشغيلي (D-001 → D-255)
```
...
سجلّ البلاغات والقرارات: [`.memory/decisions.md`](.memory/decisions.md) (D-001 → D-255) · [`.memory/issues.md`](.memory/issues.md) (ISS-001 → ISS-167). كلاهما سجلٌّ مُلحَق-فقط يشمل الإخفاقات — وبلاغُ كارثةٍ بلا جذرٍ مكتوب ليس مُغلَقاً.
...
|---|---|---|
| 🏛️ الدستور | [`CLAUDE.md`](CLAUDE.md) | القانون التشغيلي الدائم (D-001 → D-255). لا يحمل سرداً مؤرَّخاً ولا جداول حالة |
