...
└── CLAUDE.md               the operational constitution (D-001 → D-229)
```
...
| Level | Source | Role |
|---|---|---|
| 🏛️ Constitution | [`CLAUDE.md`](CLAUDE.md) | Permanent operational law (D-001 → D-229). Holds no dated narrative and no status tables |
