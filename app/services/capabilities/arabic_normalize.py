...
CANONICAL_TOPICS: tuple[CanonicalTopic, ...] = (
    _topic(
        ...
        raw_aliases=(
            ...
            "الأعداد العقدية",
            "الشكل المثلثي",
            # ISS-114 (D-106): صياغة الطلاب الشائعة «الدوال المركبة» تقصد الأعداد
            # المركبة. بدونها كان «تمرين الدوال المركبة 2024» يسقط لتعادل السنة
            # فيفوز تمرين الاحتمالات (الأول) — كارثة حية.
            "دوال مركبة",
            "الدوال المركبة",
            "دالة مركبة",
            "الدالة المركبة",
