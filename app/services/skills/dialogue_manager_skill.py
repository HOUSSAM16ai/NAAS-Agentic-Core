...
class DialogueManagerSkill:
    ...
    1. يتلقى القرار التربوي من PedagogicalPolicyEngine.
    2. يُنفذ الإجراء المحدد (التصعيد، الخطوة الوسطى، إلخ) ويربطه بالمحرك الرمزي.
    3. fail-open: المُنادي يلتقط أي خطأ ويعود للسلوك القائم.
    """
