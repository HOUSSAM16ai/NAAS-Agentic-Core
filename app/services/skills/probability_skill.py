...
from app.services.skills.probability_vocab import (
    _ARABIC_CARDINALS,
    _COLOR_CSS_TOKEN,
    _COLOR_GROUPS,
    _CONFUSION_MARKERS,
    _DUAL_NOUNS,
    _FOLLOWUP_PROBABILITY_INTENT,
    _ITEM_SINGULAR,
    _NUMBERED_ENTITY_MARKERS,
...
# ── المفردات (جداول الكيانات/الأنماط الحتمية) مُستخرَجة إلى probability_vocab
# (D-182 Stage B) ومُعاد استيرادها أعلاه فتبقى globals لهذه الوحدة (المهارة تقرؤها
# كما كانت). الـ regex الحتمية أدناه بقيت قرب مُستهلكها `_normalize`.
