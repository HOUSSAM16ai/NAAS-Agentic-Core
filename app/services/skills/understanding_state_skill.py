    ...
    def knowledge_components(self, combo) -> list[KnowledgeComponent]:
        ...
        kcs: list[KnowledgeComponent] = [
            KnowledgeComponent(
                ...
                representations=(
                    # D-191 (ISS-140 د): بلا تعداد ألوانٍ لم يذكرها الطالب — القاعدة
                    # عامّة وتنطبق على كيسه هو.
                    f"الحادثة A تتحقّق حين تكون الكرات الـ{k} **من لونٍ واحد** مهما كان ذلك اللون.",
