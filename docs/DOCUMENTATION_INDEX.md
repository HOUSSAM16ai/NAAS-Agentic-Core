...
| [`architecture/NAAS_VERIFICATION_LAYER.md`](architecture/NAAS_VERIFICATION_LAYER.md) · [`architecture/AGENT_TRUST_CONTROL_PLANE.md`](architecture/AGENT_TRUST_CONTROL_PLANE.md) · [`adr/ADR-017-agent-trust-control-plane.md`](adr/ADR-017-agent-trust-control-plane.md) | 🛡️ **مسار التحقق المؤسسي المستقل** — القانون القائم للتحقق خماسي الأبعاد + المعمارية المستهدفة المتدرجة من `Agent Action Assurance` إلى طبقة ثقة وتحكم، مع فصل صريح بين القدرة المثبتة وخارطة الطريق. حقيقة التنفيذ في [`../.memory/naas_verification_truth.md`](../.memory/naas_verification_truth.md). |
| [`commercial/AGENT_ACTION_ASSURANCE_INVESTMENT_CASE.md`](commercial/AGENT_ACTION_ASSURANCE_INVESTMENT_CASE.md) | 📈 **حالة الاستثمار المبنية على الدليل لمسار NAAS** — ألم موثق بأبحاث محكّمة ومعايير رسمية، مشترٍ وعرض أولي محددان، عقد ROI قابل لإعادة الحساب، بوابات تمويل، منافسة واختبارات تفنيد؛ لا ضمان عائد أو ادعاء إيراد. |
| [`commercial/FX_OPPORTUNITY_PORTFOLIO.md`](commercial/FX_OPPORTUNITY_PORTFOLIO.md) · [`commercial/FX_OPPORTUNITY_PORTFOLIO.json`](commercial/FX_OPPORTUNITY_PORTFOLIO.json) | 💱 **محفظة R&D لمصادر الدخل المستقبلية بالعملة الصعبة** — ترتيب حتمي لفرص داخل الخطوط السبعة، مع مشترٍ وألم ودليل معاكس وتجربة تالية وبوابة نجاح ومعيار قتل؛ كلها بحث لا إيراد مثبت. |
