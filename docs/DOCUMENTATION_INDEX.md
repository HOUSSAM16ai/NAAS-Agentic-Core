...
|---------|--------|------|
| 🏛️ الدستور | `CLAUDE.md` | القوانين التشغيلية الدائمة + سجلّ العقائد §6.x (D-001→**D-271** · آخرها **D-267**: دستور طبقة التحقّق — المُتحقِّق منتجٌ بحدٍّ مستقلّ والدليل قبل الادّعاء §0.19 · و**D-266**: دستور فرض الحوكمة — البرهان الثلاثي يمتدّ من الكود إلى الفارض §0.18 · و**D-265**: دستور حوكمة Spec Kit — طبقة ضبط تنفيذ فوق الدستورية L1–L10 · و**D-264**: دستور المخطط الدراسي التكيفي Adaptive AI Study Planner L1–L10 · وD-263: دستور المحرك التربوي — العقل التربوي كـmoat + القوانين العشرة الصارمة L1–L10، وD-262: قشرة تفويض `services/overmind/graph/main.py` + شرائح `graph/graph_support/`). **لا يحمل حالات ولا سرداً مؤرَّخاً** (D-188) · **الإضافة لا الحذف:** كل دستورٍ يعلو السابق في نطاقه دون إلغاء قانونٍ قائم |
