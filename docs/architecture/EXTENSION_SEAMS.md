...
- **⚠️ تحديث 2026-08-01 (D-201 · ADR-007):** المقعد **شُغِل جزئياً بقرارٍ صريح من المالك** لا
  ...
  وRedpanda في compose موجودان لكن **لم يُشغَّل وسيطٌ قطّ** في بيئة التحقّق (لا Docker daemon)،
  فهما DORMANT في `.memory/runtime_truth.md`. صندوق الصادر يبقى آلية الذرّية؛ الناقل فان-آوت.
...
|---------|--------|-------------|--------------------|
| **Kafka** | **PARTIAL (D-201)** — الانضباط ACTIVE، الوسيط DORMANT | تبنٍّ صريح من المالك (2026-08-01)؛ شرط الحِمل لم يتحقّق | §1 (مُصرِّف الـ relay) · ADR-007 |
| **Temporal** | **PARTIAL (D-201)** — الخطط ACTIVE، العامل DORMANT | تبنٍّ صريح من المالك لثلاثة أعمال دائمة | ADR-008 · `shared/workflows` |
