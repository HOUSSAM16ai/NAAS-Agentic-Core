...
_EXPLANATION_PATTERNS: tuple[str, ...] = (
    # طلب الشرح الصريح
    "اشرح", "شرح", "وضح", "فسر", "explain", "describe",
    # طلب المساعدة
    "ساعدني", "ساعد", "help me", "help with",
    # إشارة لمحتوى مُقدَّم من المستخدم
    "هذا التمرين", "هذه المسألة", "هذا السؤال", "هذا الجزء",
    "الجزء أ", "الجزء ب", "الجزء ج",
    "الجزء الأول", "الجزء الثاني", "الجزء الثالث",
    "part a", "part b", "part c",
    # طلب الفهم المفاهيمي
    "كيف", "لماذا", "ما هو", "ما هي", "ما معنى", "ما مفهوم",
    "how", "why", "what is", "what are", "what does",
)

# ── أنماط نية الاسترجاع الصريحة (الأولوية الثانية) ──────────────────────────
_RETRIEVAL_PATTERNS: tuple[str, ...] = (
    # بكالوريا صريحة
    "تمرين بكالوريا", "تمارين بكالوريا", "بكالوريا", "bac", "baccalauréat",
    # موضوع محدد
    "تمرين احتمالات", "تمارين احتمالات", "exercise probability", "probability exercise",
    # موضوع امتحان
    "الموضوع الأول", "الموضوع الثاني", "الموضوع الثالث",
    "subject 1", "subject 2", "subject 3",
    # تمرين مُرقَّم
    "التمرين الأول", "التمرين الثاني", "التمرين الثالث", "التمرين الرابع",
    "exercise 1", "exercise 2", "exercise 3",
    # طلب صريح للجلب
    "أعطني تمرين", "أعطني تمارين", "أريد تمرين", "أريد تمارين",
    "give me exercise", "give me exercises", "fetch exercise", "get exercise",
    "ابحث عن تمرين", "جلب تمرين",
)
