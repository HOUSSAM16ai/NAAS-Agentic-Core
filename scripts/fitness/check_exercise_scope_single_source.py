...
طالب حقيقي طلب «السؤال الأول فقط» ثلاث مرّات فلم يحصل عليه (ISS-141). أحد الأعطاب
...
#: تشمل الصورتين المُعرَّفة والنكرة معاً: إغفالُ النكرة هو العطب الذي وُلدت منه ISS-141.
