...
CLAUDE_MD_MAX_LINES = 1028  # D-243 → D-263: رفعٌ معلَن (1025 → 1028) — الدستور الجديد D-263 (العقل التربوي كـmoat) لُقِّطت قاعدته في §0.15، ودستورٌ يعلو كل دستورٍ تربوي مكانُه العقد لا ملحقٌ (نفس منطق D-209/D-210/D-228: قانونٌ دائم جديد من قرار المالك، والسرد كله في .memory/pedagogy_engine_constitution.md). القرار في .memory/decisions.md (D-263)، والمِسنَن «يتقلّص فقط» من 1028 فورًا
