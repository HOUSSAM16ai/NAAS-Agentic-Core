...
CLAUDE_MD_MAX_LINES = 1194  # D-270/D-271: رفعٌ معلَن (1132 → 1194) — §0.22 معايير التسليم + §0.23 معايير الوكلاء المفتوحة؛ دستوران من قرار المالك بطلبٍ صريح «إضافةً لا حذفاً»، والسرد كلّه في docs/architecture/{DELIVERY,OPEN_AGENT}_STANDARDS.md و.memory/*_standards_truth.md وأربعة سجلّات JSON؛ والسابق D-268/D-269: رفعٌ معلَن (1097 → 1132) — §0.20 التقاط السرّ + §0.21 الهوية المعرفية المحيطة؛ والسابق D-267: رفعٌ معلَن (1085 → 1097) — §0.19 دستور طبقة التحقّق؛ والسابق D-266: رفعٌ معلَن (1060 → 1085) — §0.18 دستور فرض الحوكمة؛ والسابق D-263 → D-265: رفعٌ معلَن (1028 → 1060) — دستوران جديدان من قرار المالك (D-264 مخطط الدراسة التكيفي §0.16 · D-265 حوكمة Spec Kit §0.17) لُقِّطت قاعدتهما في CLAUDE.md، ودستورٌ يعلو دستورٍ مكانُه العقد لا ملحقٌ (نفس منطق D-209/D-210/D-228/D-263: قانونٌ دائم جديد من قرار المالك، والسرد كله في .memory/adaptive_study_planner_constitution.md وspec_kit_governance_constitution.md). القرار في .memory/decisions.md (D-264/D-265)، والمِسنَن «يتقلّص فقط» من 1060 فورًا
